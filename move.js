...
function changeposition1(old, current) {
    ...
    console.log("person1 play", person[1]);
...
function changeMoney2(p2) {
    ...
    if (updateMoney > 0) {
        ...
        document.querySelector(".item4").innerHTML = "player 2 win";
    }

}
player1_button.addEventListener("click", function () { player1.rolldice1(); }, false);
player2_button.addEventListener("click", function () { player2.rolldice2(); }, false);
